...
\Ref{Section}{sec:Fonts} for more information \autocite{GravitationalWaves}.
...
\begin{displayquote}[after Cicero]
    \blindtext
\end{displayquote}
...
\begin{itemize}
    ...
    \item References:
        ...
        \Ref{Figure}{fig:Shapes};
        \SubRef{Panel}{subfig:Rectangle}.
